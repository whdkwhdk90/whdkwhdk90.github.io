...
<ul>
    ...
    <li>GitHub : https://github.com/whdkwhdk90</li>
</ul>

## 수료교육
<ul>
    <h4>JAVA를 이용한 웹개발자 양성과정(2020.03 ~ 2020.10)</h4>
</ul>  

## 학력
<ul>
    <h4>화홍고등학교 졸업(2010.3 ~ 2013.2)</h4>
    <h4>단국대학교 응용컴퓨터공학과 졸업(2013.3 ~ 2017.2)</h4>
</ul>    
...
#### 개발 목표 
    대세 TV프로그램 '골목 식당'처럼 음식을 카테고리 별, 혹은 랜덤으로 추천하는 기능으로 
    음식 선택에 어려움을 느끼는 사람들에게 조금이나마 고민거리를 덜어 줄 수 있도록 하는 사이트 구현 <br/>
